...
from .data_generation import BaseGenerator
from .utils import LOGS_DIR, MODELS_DIR, TENSORBOARD_DIR, calc_metric
from .metrics import ALPHABET
...
def get_callbacks(model_num: int, train_gen: BaseGenerator,
                  val_gen: BaseGenerator) -> List[Callback]:
