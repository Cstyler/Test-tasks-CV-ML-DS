...
def train(train_df_name, val_df_name, img_file, model_num, initial_epoch, epochs, train_augment_prob, batch_size,
    ...
    train_gen = BatchGenerator(train_df, batch_size, imgs, max_text_len,
    ...
    val_gen = BatchGenerator(val_df, batch_size, imgs, max_text_len, shuffle=False)
    ...
    model.fit(train_gen, steps_per_epoch=train_gen.steps_per_epoch, epochs=epochs,
                        ...
                        workers=1, max_queue_size=20, initial_epoch=initial_epoch,
